...
# Model for img2img when user uploads an image (using official Flux 1.1 Pro Ultra which handles arbitrary sizes)
FLUX_IMG2IMG_MODEL = "black-forest-labs/flux-1.1-pro-ultra"
